...
<% Title = Session.Contents("strUserName") & "的日记本—书写" %>
<%
...
If Session.Contents("PN_MUDiaryMaster_" & Session.Contents("strUserName")) And strUserName <> "" And dtmDateTime <> "" And strWeather <> "" And strTitle <> "" And strContent <> "" Then
	ConnectionDatabase
